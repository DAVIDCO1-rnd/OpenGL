...
%just identification of boundary, no tracking (blocked/commented)
%for tracking see find_delaunay_boundary03_fig.m or the original file
%find_delaunay_boundary03.m
