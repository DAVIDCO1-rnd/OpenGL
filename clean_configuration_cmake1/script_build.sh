...
g++ -std=c++17 -Wall -g -I Third_party/include -I include -I /usr/local/include/opencv4 src/Camera.cpp src/EBO.cpp src/Main.cpp src/Mesh.cpp src/Model.cpp src/shaderClass.cpp src/stb.cpp src/Texture.cpp src/VAO.cpp src/VBO.cpp imgui_impl_opengl3.o imgui_impl_glfw.o glad.o -lopencv_calib3d -lopencv_core -lopencv_features2d -lopencv_flann -lopencv_highgui -lopencv_imgcodecs -lopencv_imgproc -lopencv_ml -lopencv_objdetect -lopencv_photo -lopencv_stitching -lopencv_video -lopencv_videoio -lglfw -ldl -o main